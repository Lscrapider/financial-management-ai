...
export const VALID_TAGS_BY_CATEGORY: Record<string, string[]> = {
  ...
  price: [
    ...
    'gap_up',
    'gap_down',
    'convertible_high_price_risk',
    'convertible_low_price_defensive',
    'fund_nav_rise',
    'fund_nav_drop',
  ],
  volume: [
  ...
  valuation: [
    ...
    'valuation_trap',
    'fundamental_risk',
    'convertible_low_premium',
    'convertible_high_premium',
    'convertible_premium_compression',
    'convertible_premium_expansion',
    'convertible_debt_floor_support',
    'convertible_high_ytm',
    'convertible_low_ytm',
    'convertible_high_conversion_value',
    'fund_premium',
    'fund_discount',
    'fund_high_fee',
    'fund_large_scale',
  ...
  sentiment: [
    ...
    'convertible_stock_linkage',
    'convertible_independent_strength',
    'fund_flow_in',
    'fund_flow_out',
  ],
  risk_strategy: [
