...
@Service
public class SceneKnowledgeRetrievalServiceImpl implements SceneKnowledgeRetrievalService {
    ...
    public SceneKnowledgeRetrievalServiceImpl(KnowledgeVectorManage knowledgeVectorManage) {
    ...
    @Override
    public List<SceneKnowledgeRetrievalTaskDTO> buildRetrievalTasks(
    ...
    @Override
    public List<SceneKnowledgeRetrievalTaskDTO> retrievalTasks(
    ...
    @Override
    public Map<String, List<SceneKnowledgeChunkDTO>> retrieveKnowledge(
            List<SceneRetrievalEmbeddingParam> retrievalEmbeddings) {
