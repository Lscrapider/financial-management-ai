...
- pullback: 回调，文本讨论上涨趋势中的回调、回踩、调整，且原趋势尚未明显破坏
- repair: 修复，文本讨论下跌或弱势之后企稳、跌幅收敛、缓慢回升、修复结构
- trend_reversal: 趋势反转，文本讨论趋势由弱转强、由强转弱、反转信号、拐点
- breakout_from_range: 横盘突破，文本讨论长期横盘后突破、箱体突破、平台突破
- breakdown_from_range: 区间破位，文本讨论横盘或支撑之后向下脱离区间、跌破平台、跌破关键支撑
- continuation: 趋势延续，文本讨论前序趋势和当前趋势方向一致、上涨延续、下跌延续、趋势继续
- turn_weak: 转弱，文本讨论上涨后动能衰减、上攻乏力、跌破支撑、趋势开始走弱
- turn_strong: 转强，文本讨论下跌或横盘后重心抬升、走势转强、弱势改善、开始抬升
...
### risk_strategy（风险/策略）
- chase_high_risk: 追涨停、追高、追热点风险，文本提醒上涨后不要盲目追、接近高位要谨慎、涨多了风险变大
- false_breakout_risk: 假突破风险，文本讨论突破后可能失败、冲高回落、站不稳、骗线
- liquidity_risk: 流动性风险，文本讨论成交差、买卖困难、流动性不足、小票无法及时退出
- drawdown_risk: 回撤风险，文本讨论可能回撤、下跌空间、亏损扩大、短线回落风险、最大回撤、浮亏扩大
...
- wait_confirm: 等待确认，文本讨论不要马上判断、等确认、等站稳、等第二天走势验证、信号确认、等条件满足
